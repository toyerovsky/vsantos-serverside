...
namespace VRP.DAL.Migrations
{
    ...
    [Migration("20180913093121_ChangeVehicleForeignKeysToNull")]
    partial class ChangeVehicleForeignKeysToNull
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VRP.DAL.Database.Models.Building.ResidentModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VRP.DAL.Database.Models.Agreement.AgreementModel", b =>
                {
                    b.HasOne("VRP.DAL.Database.Models.Character.CharacterModel")
                        .WithMany("Agreements")
                        .HasForeignKey("CharacterModelId");

                    b.HasOne("VRP.DAL.Database.Models.Group.GroupModel")
                        .WithMany("Agreements")
