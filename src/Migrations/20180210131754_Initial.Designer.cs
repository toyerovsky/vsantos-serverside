...
namespace Serverside.Migrations
{
    ...
    [Migration("20180210131754_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.AccountModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.BuildingModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.CharacterModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<DateTime?>("PlayedTime");
                    ...
                    b.Property<DateTime?>("TodayPlayedTime");
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.CrimeBotModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.DescriptionModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.GroupModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<long?>("BossCharacterId");
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.GroupWarehouseItemModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.GroupWarehouseOrderModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.ItemModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.PenaltyModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.TelephoneContactModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<long?>("CellphoneId");
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.TelephoneMessageModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.VehicleModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.WorkerModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.BuildingModel", b =>
                {
                    b.HasOne("Serverside.Core.Database.Models.CharacterModel", "Character")
                        .WithMany("Buildings")
                        .HasForeignKey("CharacterId");

                    b.HasOne("Serverside.Core.Database.Models.AccountModel", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Serverside.Core.Database.Models.GroupModel", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.CharacterModel", b =>
                {
                    b.HasOne("Serverside.Core.Database.Models.AccountModel", "AccountModel")
                        .WithMany("Characters")
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.CrimeBotModel", b =>
                {
                    ...
                    b.HasOne("Serverside.Core.Database.Models.GroupModel", "GroupModel")
                        .WithMany()
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.GroupModel", b =>
                {
                    b.HasOne("Serverside.Core.Database.Models.CharacterModel", "BossCharacter")
                        .WithMany()
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.GroupWarehouseItemModel", b =>
                {
                    b.HasOne("Serverside.Core.Database.Models.ItemModel", "ItemModel")
                        .WithMany()
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.GroupWarehouseOrderModel", b =>
                {
                    b.HasOne("Serverside.Core.Database.Models.GroupModel", "Getter")
                        .WithMany()
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.ItemModel", b =>
                {
                    b.HasOne("Serverside.Core.Database.Models.BuildingModel", "Building")
                        .WithMany("Items")
                    ...
                    b.HasOne("Serverside.Core.Database.Models.VehicleModel", "Vehicle")
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.PenaltyModel", b =>
                {
                    b.HasOne("Serverside.Core.Database.Models.AccountModel", "Account")
                        .WithMany("Penalties")
            ...
            modelBuilder.Entity("Serverside.Core.Database.Models.TelephoneContactModel", b =>
                {
                    b.HasOne("Serverside.Core.Database.Models.ItemModel", "Cellphone")
                        .WithMany()
