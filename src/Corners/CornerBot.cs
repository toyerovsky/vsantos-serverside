...
namespace Serverside.Corners
{
    public class CornerBot : Bot
    {
        ...
        public CornerBot(EventClass events, string name, PedHash pedHash, FullPosition spawnPosition, List<FullPosition> nextPositions, DrugType drugType, decimal moneyCount, string greeting, string goodFarewell, string badFarewell, AccountEntity seller, int botId) : base(events, name, pedHash, spawnPosition)
        {
            BotId = botId;
